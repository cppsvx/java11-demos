package com.craneos.demos.spring.awarefactory.controller;
...
public class AwareFactoryController {

    @Autowired
    private ApplicationContext applicationContext;

    public AwareFactoryController(){
        System.out.println("Instantiation of awareController");
    }

    @GetMapping("/beanFromFactory")
    public String awareFromFactory() {
        AwareFactoryService myBeanFactory = applicationContext.getBean(AwareFactoryService.class);
        return myBeanFactory.getMyBeanNameFromFactory();
    }
