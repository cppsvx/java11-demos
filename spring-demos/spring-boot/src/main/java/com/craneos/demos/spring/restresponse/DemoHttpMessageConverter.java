package com.craneos.demos.spring.restresponse;
...
public class DemoHttpMessageConverter extends DemoBase {

    public static void main(String[] args) {
        SpringApplication.run(DemoHttpMessageConverter.class, args);
    }
