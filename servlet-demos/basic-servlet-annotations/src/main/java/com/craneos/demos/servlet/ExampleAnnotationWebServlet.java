...
/**
 * http://localhost:8180/basic-servlet-annotations/annotation
 */
@WebServlet(urlPatterns = "/annotation", loadOnStartup = 1)
public class ExampleAnnotationWebServlet extends HttpServlet {

    private static final java.util.logging.Logger LOGGER_UTIL = java.util.logging.Logger.getLogger("ExampleAnnotationWebServlet");
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(ExampleAnnotationWebServlet.class);
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("Hello World with ANNOTATIONS");
        out.println("</body>");
        out.println("</html>");
    }
}
